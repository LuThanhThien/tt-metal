...
def get_or_create_sqlite_db(report_path):
    ...
    # Lu Thien 2024.08.21 - Add check_same_thread=False to sqlite3.connect
    SQLITE_CONNECTION = sqlite_connection = sqlite3.connect(sqlite_db_path, check_same_thread=False)
